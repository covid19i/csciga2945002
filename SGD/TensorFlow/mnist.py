...
#weights = tf.Variable(tf.zeros_initializer(shape=(784, 10), dtype=tf.float64))
#biases  = tf.Variable(tf.zeros_initializer(shape=(10,), dtype=tf.float64))
weights = tf.Variable(tf.zeros(shape=(784, 10), dtype=tf.float64))
